...
public class SparkJobServer extends AbstractExecutor {
     ...
     * @throws ExecutorConfigException
     */
    private SparkCluster getSparkClusterExecutor(ExecutorConfig executorConf) throws ExecutorConfigException, HAExecutorException {
    ...
    public static void main(String[] args) throws ExecutorConfigException, ExecutorException, HAExecutorException {
